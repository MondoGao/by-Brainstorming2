...
function fillCard() {
    ...
    for(var i = 0; i < type.length; i++) {
        ...
        card.querySelector('img').src = "img\/icon\/" + type[i] + '\/' + cardData[type[i]][result[i].index].eng + ".svg";
        ...
        title.push(cardData[type[i]][result[i].index].name);
